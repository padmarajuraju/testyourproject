...
function EditProfile() {
    ...
    const getUserDetailsById = (id) => {
        ...
        var url = "http://52.71.36.236:8080/user-service/api/v1/vaccination-center/" + id;
        return fetch(url,
            {
                headers: {
...
function updateUserDetails(user) {
    ...
    var url = "http://52.71.36.236:8080/user-service/api/v1/vaccination-center/" + user.centerId;
