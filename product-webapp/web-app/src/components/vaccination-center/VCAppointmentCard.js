...
import axios from 'axios';
 ...
 function AppointmentCard(props) {
  ...
  let url = "http://3.90.253.77:8080/slot-booking-service/api/v1/slot/status/"+slotid+"?status=EXPIRED";
	axios.put(url).then(res=>{
	})
  
  // var url2 = "http://localhost:8080/vaccination-center-service/api/v1/slots/update/"+slotid+"?status=EXPIRED"
  var url2 = "http://3.90.253.77:8080/vaccination-center-service/api/v1/slots/update/"+slotid+"?status=EXPIRED"
  ...
  let url = "http://3.90.253.77:8080/slot-booking-service/api/v1/slotdelete/"+slotemail;
  ...
  var url2 = "http://3.90.253.77:8080/vaccination-center-service/api/v1/slots/"+slotidc;
