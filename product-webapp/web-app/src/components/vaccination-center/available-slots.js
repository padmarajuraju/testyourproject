...
function AvailableSlots() {
    ...
    const onSubmit = (event) => {
        ...
        // if (slotsDetails?.length == 0) {
            ...
            fetch('http://18.222.135.175:8080/vaccination-center-service/api/v1/slots/create', requestOptions)
                .then((result) => {
    ...
    const onEditSubmit = (event) => {
        ...
        fetch('http://18.222.135.175:8080/vaccination-center-service/api/v1/slots/update', requestOptions)
            .then((result) => {
                if (result.status === 200) {
                    setEditOpen(false)
                    getSlotsDetails();
    ...
    const onDelete = (event) => {
        ...
        fetch('http://18.222.135.175:8080/vaccination-center-service/api/v1/slots/' + modalSlotData.slotId, requestOptions)
            .then((result) => {
                if (result.status === 200) {
                    setEditOpen(false)
                    getSlotsDetails();
    ...
    const getSlotsDetails = () => {
        return fetch("http://18.222.135.175:8080/vaccination-center-service/api/v1/slots/available/center/" + emailPass, {
            headers: {
