...
function Confirmation() {
  ...
  function ConfirmAppointment() {
    ...
    if (apt == null || apt === "undefined" || apt.slot == null || apt.slot === "undefined") {
      ...
      fetch('http://52.71.36.236:8080/slot-booking-service/api/v1/slot',
        {
          headers: {
  ...
  function updateStatusAsBooked(slotId) {
    ...
    let url = "http://52.71.36.236:8080/slot-booking-service/api/v1/slot/status/" + slotId + "?status=BOOKEED";
    return fetch(url,
      {
        headers: {
          'Content-Type': 'application/json',
