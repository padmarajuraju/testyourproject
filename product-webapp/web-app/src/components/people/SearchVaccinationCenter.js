...
///Set Date
    ...
    const getVCenters = (reseting) => {
        ...
        // fetch("http://localhost:8080/user-service/api/v1/vaccination-center/getAllVaccinationCenter", {
            fetch("http://52.71.36.236:8080/user-service/api/v1/vaccination-center/getAllVaccinationCenter", {
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            }
    ...
    async function getVaccineDetails(e, reseting) {
        ...
        if (reseting == true) {
            ...
            url = 'http://52.71.36.236:8080/vaccination-center-service/api/v1/slots/available/count/' + e.centerEmail + '?date=' + today;
            document.getElementById('date').value = today;
        }
        else {
            // url = 'http://localhost:8080/vaccination-center-service/api/v1/slots/available/count/' + e.centerEmail + '?date=' + newdate;
            url = 'http://52.71.36.236:8080/vaccination-center-service/api/v1/slots/available/count/' + e.centerEmail + '?date=' + newdate;
        }
    ...
    const getVCentersByPIN = (pinreset) => {
        ...
        // return fetch("http://localhost:8080/user-service/api/v1/vaccination-center/getAllVaccinationCenter", {
            return fetch("http://52.71.36.236:8080/user-service/api/v1/vaccination-center/getAllVaccinationCenter", {
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            }
    ...
    const dateFilter = () => {
        ...
        successcount = 0;
         tempVCenter.map((e) => {
            ...
            let url = 'http://52.71.36.236:8080/vaccination-center-service/api/v1/slots/available/count/' + e.centerEmail + '?date=' + newdate;
            try {
    ...
    const datePINFilter = () => {
        ...
        let url1 = "http://52.71.36.236:8080/user-service/api/v1/vaccination-center/getAllVaccinationCenter";
            ...
            axios.get(url1).then(res => {
                ...
                if (tempVCenter.length > 0) {
                    tempVCenter.map((e) => {
                        ...
                        let url2 = 'http://52.71.36.236:8080/vaccination-center-service/api/v1/slots/available/count/' + e.centerEmail + '?date=' + newdate1;
                        try {
