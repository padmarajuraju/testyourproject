...
function Profile() {
    ...
    const getUserData = () => {
        ...
        let url = "http://3.90.253.77:8080/user-service/api/v1/user/user/" + emailPass ;
    ...
    function fetchBookedSlot(data) {
        ...
        let url = "http://3.90.253.77:8080/slot-booking-service/api/v1/getByUserEmail/" + emailPass;
